...
{
	public static var gabVersion:String = '0.1.2'; //Used for discord RPC 
	...
	override function create()
	{
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 44, 0, "Gab Engine v" + gabVersion + " (0.5.2h)", 12);
